...
import com.api.forohub.domain.topico.respuesta.validaciones.ValidadorRespuesta;
...
public class RespuestaService {
    ...
    public DatosRespuesta crearRespuesta(CrearRespuestaDTO datos) {
    ...
    public DatosRespuesta editarRespuesta(EditarRespuestaDTO datos) {
    ...
    public EstadoTopicoRespuesta marcarDesmarcarComoSolucion(Long id) {
        ...
        var resultado = new EstadoTopicoRespuesta(new TopicoDTO(topico), new DatosRespuesta(respuesta));
        return resultado;
    }
